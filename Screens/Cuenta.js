        ...
        <View style={styles.container}>
            ...
            <View style={styles.helpSection}>
                ...
                <View style={styles.contenedorAyuda}>
                    ...
                    {/* Nuevos botones que llevan a otras pantallas */}
                        <View 
                            style={styles.staticInput} 
                        >
                            <Text style={styles.staticInputText}>Ayuda y soporte
                        ...
                        >
                                <Text style={styles.staticInputText}>Contacto: +54 2995759025</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity 
                            style={styles.staticInput} 
                            onPress={() => navigation.navigate('TerminosyUso')}
                        >
                            <Text style={styles.staticInputText}>Terminos y uso de privacidad</Text>
                        </TouchableOpacity>
                </View>
